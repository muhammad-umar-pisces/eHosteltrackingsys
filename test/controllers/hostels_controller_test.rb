...
class HostelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post hostels_url, params: { hostel: { hostel_name: @hostel.hostel_name, location: @hostel.location, price: @hostel.price } }
    end
  ...
  test "should update hostel" do
    patch hostel_url(@hostel), params: { hostel: { hostel_name: @hostel.hostel_name, location: @hostel.location, price: @hostel.price } }
